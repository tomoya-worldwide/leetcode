...
## 練習方法(1周目想定)
自分の言語で完走した人を2,3人探し、その中の回答を使って Step. 3 をする。つまり、暗記して見ずに10分以内で安定して(3回くらい)書けるようにする。これで一問完了です。想定、1問1時間くらいでしょうか。覚えたやつはレビューを依頼する必要はないですが GitHub に元へのリンクと共においておけばいいでしょう。

これを60問に対してやります。終わったら以前の方法でやりなおしてもいいでしょう。
